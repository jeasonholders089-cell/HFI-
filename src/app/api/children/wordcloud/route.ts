...
export async function POST(){
 try{
 const rows=await getDb().select({id:children.id,age:children.age,interests:children.interests,activities:children.activities,selfDescription:children.selfDescription,parentObservation:children.parentObservation,dreamCareer:children.dreamCareer}).from(children);
